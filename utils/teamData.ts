...
export const mergeTeamWithFallback = (
    ...
    return {
        ...
        crestScale: sanitizedTeam?.crestScale ?? sanitizedSource.crestScale,
        crestOffsetY: sanitizedTeam?.crestOffsetY ?? sanitizedSource.crestOffsetY,
...
export const normalizeTeamCollection = (items: Partial<TeamAsset>[], fallbacks: TeamAsset[] = []): TeamAsset[] => {
    ...
    items.forEach((item) => {
        ...
        deduped.set(key, {
            ...
            crestScale: item?.crestScale ?? previous.crestScale,
            crestOffsetY: item?.crestOffsetY ?? previous.crestOffsetY,
...
export const normalizeManagedTeamRecord = (team: Partial<ManagedTeam> | undefined): ManagedTeam => {
    ...
    return {
        ...
        crestScale: raw.crestScale,
        crestOffsetY: raw.crestOffsetY,
