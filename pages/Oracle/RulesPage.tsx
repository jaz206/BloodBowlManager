...
const RulesPage: React.FC = () => {
    ...
    return (
        <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-2">
                    {sections.map((section) => (
                        <button
                            ...
                            className={`flex items-center justify-center gap-2 py-3 px-4 rounded-2xl font-black text-[10px] uppercase tracking-widest transition-all ${
                                activeSection === section.id
                                    ? 'bg-[#ca8a04] text-[#2b1d12] shadow-[0_10px_24px_rgba(202,138,4,0.22)]'
                                    : 'text-[#7b6853] hover:text-[#2b1d12] hover:bg-white/55'
                            }`}
                        >
            ...
            <footer className="pt-10 pb-20 border-t border-[rgba(111,87,56,0.12)] text-center">
                <p className="text-[#7b6853] text-[10px] font-black uppercase tracking-[0.3em] italic">
