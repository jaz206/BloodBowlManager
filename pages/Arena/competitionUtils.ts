...
export const cloneCompetition = (comp: Competition): Competition => {
    const newComp: Competition = {
        ...
        format: comp.format,
        phase: comp.phase,
        seasonNumber: comp.seasonNumber,
        ...
        participantIds: comp.participantIds ? [...comp.participantIds] : comp.participantIds,
        joinCode: comp.joinCode,
        visibility: comp.visibility,
        maxTeams: comp.maxTeams,
        status: comp.status,
        rules: comp.rules ? { ...comp.rules } : undefined,
        scheduling: comp.scheduling ? { ...comp.scheduling } : undefined,
