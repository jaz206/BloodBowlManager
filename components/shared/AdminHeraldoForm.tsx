    ...
    return (
        <div className="space-y-8">
                ...
                <div className="flex items-center gap-4 mb-4">
                    ...
                    <div>
                        ...
                        <p className="text-[10px] text-slate-500 uppercase font-black tracking-widest mt-1">
                            Los campos se adaptaran visualmente en el Heraldo segun tu eleccion.
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-4">
                    ...
                    >
                        ...
                        <option value="team">Equipo/Franquicia (Escudo + Cronica)</option>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="space-y-4">
                    <label className="block text-[10px] font-black text-slate-500 uppercase tracking-widest ml-1">Subtitulo / Categoria</label>
                    <input
                        type="text"
            ...
            <div className="space-y-4">
                ...
                <textarea
                    ...
                    placeholder="Escribe la historia aqui..."
                />
            </div>
