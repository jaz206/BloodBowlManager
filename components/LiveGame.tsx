...
const cloneLiveTeam = (team: ManagedTeam): ManagedTeam => {
    ...
    const clonedTeam: ManagedTeam = {
        ...
        liveRerolls: team.liveRerolls,
        tempBribes: team.tempBribes,
        tempCheerleaders: team.tempCheerleaders,
        tempAssistantCoaches: team.tempAssistantCoaches,
        coachExpelled: team.coachExpelled,
        apothecaryUsedOnKO: team.apothecaryUsedOnKO,
    };
