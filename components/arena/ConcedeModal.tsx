...
interface ConcedeModalProps {
  onClose: () => void;
  onConfirm: (team: 'home' | 'opponent') => void;
  homeTeamName: string;
  opponentTeamName: string;
}

const ConcedeModal: React.FC<ConcedeModalProps> = ({ onClose, onConfirm, homeTeamName, opponentTeamName }) => {
  ...
  return (
    <div
      ...
      aria-modal="true"
    >
      <div className="glass-panel max-w-md w-full transform animate-slide-in-up border-blood-red/30 overflow-hidden shadow-[0_0_50px_rgba(220,38,38,0.2)]">
            ...
            >
              <div className="flex justify-between items-center">
                <div>
                  ...
                  <p className="text-lg font-display font-black text-white italic uppercase tracking-tighter">{homeTeamName} Concede</p>
                </div>
            ...
            >
              <div className="flex justify-between items-center">
                <div>
                  ...
                  <p className="text-lg font-display font-black text-white italic uppercase tracking-tighter">{opponentTeamName} Concede</p>
                </div>
