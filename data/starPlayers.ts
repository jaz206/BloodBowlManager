...
export const starPlayersData: StarPlayer[] = [
  ...
  },
  {
    ...
    skills: "Garras, Agallas, Esquivar, Furia, En pie de um Salto, Solitario (4+), Sin manos, Echarse a um lado, Escurridizo, Canijo, Furia Ciega",
  ...
  },
  {
    ...
    skills: "Esquivar, Mirada Hipnótica, Solitario (4+), Cola Prensil, Proteger el Cuero, Echarse a um Lado",
  ...
  },
  {
    ...
    skills: "Bombardier, Presencia Perturbadora, Esquivar, Solitario (3+), Echarse a um Lado, Furtivo, Apuñalar, Escurridizo",
